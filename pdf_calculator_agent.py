...
SYSTEM_PROMPT_SELECT_IDS = (
    ...
    "likely represents on THIS plan:\n"
    ...
    "  - Cross-check with the plan image: look at the segment's center (x%,y%) and decide "
    "whether that location is a structural wall or a symbol/annotation.\n"
